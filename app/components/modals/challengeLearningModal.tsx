      ...
      <View style={styles.modalContainer}>
        <ScrollView>
          ...
          <Text style={styles.modalText} android_hyphenationFrequency="full">
            ...
            эффективность. Нажмите кнопку 'Назад' на смартфоне, чтобы прервать
            испытание. Если вам нужно освежить правила прохождения тренировки,
            обратитесь в раздел "Обучение".
          </Text>
        </ScrollView>
        <ButtonWrapper>
          <ButtonContainer
